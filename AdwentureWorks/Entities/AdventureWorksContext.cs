...
public partial class AdventureWorksContext : DbContext
{
    ...
    //    => optionsBuilder.UseSqlServer("Name=ConnectionStrings:AdventureWorksConnectionString");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.ToTable("Apartaments", "Office");

            entity.Property(e => e.ApartamentId).HasColumnName("ApartamentID");
            entity.Property(e => e.Name).HasMaxLength(50);

            entity.HasOne(d => d.Building).WithMany(p => p.Apartaments)
                .HasForeignKey(d => d.BuildingId)
                .HasConstraintName("FK_Apartaments_Buildings");
        });
        ...
        {
            entity.ToTable("Buildings", "Office");
        ...
        modelBuilder.Entity<Miastum>(entity =>
        {
            ...
            entity.ToTable("Miasta", "Office");

            entity.Property(e => e.DataEdycji).HasDefaultValueSql("(sysdatetime())");
        ...
        {
            entity.ToTable("ParkingPlace", "Office");
            ...
            entity.HasOne(d => d.Garage).WithMany(p => p.ParkingPlaces)
                .HasForeignKey(d => d.GarageId)
                .HasConstraintName("FK_ParkingPlace_Garage");
        });
